...
class  Base{
    ...
    constructor(props){
        // canvas容器
        this.container = props.canvasContainer || document.body;
        // 相机的角度
        this.angle = props.angle || 50;
        // 相机的近角度
    ...
    createScene(){
        ...
        // 三剑客之相机
        this.camera = new THREE.PerspectiveCamera( this.angle, this.width/this.height, this.near, this.far);
